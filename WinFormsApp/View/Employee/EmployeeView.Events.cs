...
namespace WinFormsApp.View.Employee
{
    public partial class EmployeeView
    {
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            BindClick(btnCancel, () => CancelEvent, () => CancelTarget = EmployeeViewModel.List);
            BindClick(btnCancelProfile, () => CancelEvent, () => CancelTarget = EmployeeViewModel.List);
            BindClick(btnBackToEmployeeList, () => CancelEvent, () => CancelTarget = EmployeeViewModel.List);
            BindClick(btnBackToEmployeeListFromProfile, () => CancelEvent, () => CancelTarget = EmployeeViewModel.List);

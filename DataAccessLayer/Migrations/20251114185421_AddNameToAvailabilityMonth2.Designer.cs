...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20251114185421_AddNameToAvailabilityMonth2")]
    partial class AddNameToAvailabilityMonth2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccessLayer.Models.ScheduleSlotModel", b =>
                {
                    ...
                    b.HasIndex("ScheduleId", "DayOfMonth", "ShiftNo", "EmployeeId")
                        .IsUnique()
                        .HasDatabaseName("ux_slot_unique_emp_per_shift")
                        .HasFilter("employee_id IS NOT NULL");

                    b.HasIndex("ScheduleId", "DayOfMonth", "ShiftNo", "SlotNo")
                        .IsUnique();

                    b.HasIndex(new[] { "ScheduleId", "DayOfMonth", "ShiftNo" }, "ix_slot_sched_day_shift");

                    b.HasIndex(new[] { "ScheduleId", "DayOfMonth", "ShiftNo", "EmployeeId" }, "ux_slot_unique_emp_per_shift")
                        .IsUnique()
                        .HasDatabaseName("ux_slot_unique_emp_per_shift1");
